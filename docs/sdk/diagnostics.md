...
| W-002 | A mode passes pattern validation but is not in the set of modes defined by included protocol bindings (v0.1: `mcp_server`, `mcp_client`, `a2a_server`, `a2a_client`, `ag_ui_client`). Likely typo. |
